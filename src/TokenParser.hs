...
data ParseResult =
    NumResult Number            -- double result
  | UnitResult (Number,String)  -- unit conversion result
...
builtinFunctions :: [(String, Number -> Number)]
...
builtinFunctions_int :: [ (String, Number -> Maybe Integer
                        , Integer -> Integer )]
...
-- The (Double -> Maybe Integer) argument is a function with which
-- function arguments are converted to Integer values
builtinFunctions_2int :: [(String, Number -> Maybe Integer
